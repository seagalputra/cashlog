...
func (u *RepositoryImpl) Save(account *model.User) error {
...
func (u *RepositoryImpl) FindByID(id int64) (*model.User, error) {
	savedUser := new(model.User)
...
func (u *RepositoryImpl) FindByUsername(username string) (*model.User, error) {
	savedUser := new(model.User)
